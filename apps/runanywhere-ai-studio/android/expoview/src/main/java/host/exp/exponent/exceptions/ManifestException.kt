      ...
      try {
        when (it.getString("errorCode")) {
          "EXPERIENCE_SDK_VERSION_OUTDATED" -> {
            ...
            "$projectType is incompatible with this version of RunAnywhere AI Studio"
          }
          "EXPERIENCE_SDK_VERSION_TOO_NEW" -> "Project is incompatible with this version of RunAnywhere AI Studio"
          "SNACK_NOT_FOUND_FOR_SDK_VERSION" -> "This Snack is incompatible with this version of RunAnywhere AI Studio"
          else -> null
        }
      ...
      try {
        ...
        when (errorCode) {
          ...
          "EXPERIENCE_SDK_VERSION_OUTDATED" -> {
            ...
            formattedMessage =
              "• The installed version of RunAnywhere AI Studio is for <b>SDK $supportedSdk</b>.<br>" +
              "• The $projectType you opened uses <b>SDK $sdkVersionRequired</b>."
            fixInstructions = if (isSnackURL) {
              "Either select SDK $supportedSdk on <a href='https:/snack.expo.dev/'>https:/snack.expo.dev/</a> or install an older version of RunAnywhere AI Studio that is compatible with your project." +
              ...
              "Either upgrade this project to SDK $supportedSdk or install an older version of RunAnywhere AI Studio that is compatible with ${if (isSnackURL) "this" else "your"} $projectType.<br><br>" +
                "<a href='https://docs.expo.dev/workflow/upgrading-expo-sdk-walkthrough/'>Learn how to upgrade to SDK $supportedSdk.</a><br><br>"
            } + "<a href='$expoDevLink'>Learn how to install RunAnywhere AI Studio for SDK $sdkVersionRequired</a>."
            canRetry = false
          }

          "EXPERIENCE_SDK_VERSION_TOO_NEW" -> {
            formattedMessage = "This project requires a newer version of RunAnywhere AI Studio."
            fixInstructions = "Download the latest version of RunAnywhere AI Studio from the Play Store."
            canRetry = false
          }
          ...
          "SNACK_NOT_FOUND_FOR_SDK_VERSION" -> run closure@{
            ...
            formattedMessage =
              "The snack \"${fullName}\" was found, but it is not compatible with your version of RunAnywhere AI Studio. It was released for SDK $snackSdkVersionValue, but your RunAnywhere AI Studio supports only SDK $supportedSdk."

            fixInstructions = if (supportedSdk < snackSdkVersionValue) {
              "You need to update your RunAnywhere AI Studio app in order to run this Snack."
            } else {
            ...
            fixInstructions += "<br><br><a href='https://docs.expo.dev/get-started/expo-go/#sdk-versions'>Learn more about SDK versions and RunAnywhere AI Studio</a>."
            canRetry = false
          }
        }
      } catch (e: JSONException) {
